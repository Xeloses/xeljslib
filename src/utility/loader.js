 ...
 *
 * @param  {string|string[]|object} src        Script source(s), can be String (loads single script), or Array of Strings (loads multiple scripts) or Plain Object with pairs {'id_01': 'script_url_01', ... } (loads multiple scripts and sets IDs for them, prevents loading of scripts with duplicate IDs)
